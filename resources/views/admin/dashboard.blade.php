        ...
        <div class="col-md-6">
            <div class="stat-card">
                ...
                <div class="list-group list-group-flush">
                    <a href="{{ route('admin.merchants.index') }}" class="list-group-item list-group-item-action d-flex align-items-center">
                        <i class="bi bi-building me-3 text-primary"></i>
                        <span>Manage Merchants</span>
                        <i class="bi bi-chevron-right ms-auto"></i>
                    </a>
                    <a href="{{ route('admin.transactions.index') }}" class="list-group-item list-group-item-action d-flex align-items-center">
                        <i class="bi bi-credit-card me-3 text-success"></i>
                        <span>View All Transactions</span>
                        <i class="bi bi-chevron-right ms-auto"></i>
                    </a>
                    <a href="{{ route('admin.reports.index') }}" class="list-group-item list-group-item-action d-flex align-items-center">
