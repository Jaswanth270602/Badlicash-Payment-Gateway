    ...
    <div class="stat-card mb-3">
        <div class="row g-3 align-items-end">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" ng-model="arc.dateRange" placeholder="14/11/2025 00:00:00 - 29/11/2025 23:59:59">
            </div>
        </div>
    </div>
        ...
        try {
            ...
            app.controller('AdminRefundsController', ['$http', function($http) {
                ...
                vm.viewRefund = function(refund) {
                    alert('View refund: ' + refund.refund_id);
                };
...
<?php echo $__env->make('layouts.app-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ushar\OneDrive\Desktop\Badlicash-Payment-Gateway\resources\views/admin/payments/refunds.blade.php ENDPATH**/ ?>