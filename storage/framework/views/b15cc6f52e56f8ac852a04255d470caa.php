        ...
        <?php else: ?>
            <div class="payment-card">
                <div class="payment-header">
                    <h1><?php echo e($paymentLink->title); ?></h1>
                    <?php if($paymentLink->description): ?>
                        <p><?php echo e($paymentLink->description); ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="payment-body">
                    <div class="amount-section">
                        ...
                        <h2 class="amount-value">
                            <?php echo e(number_format($paymentLink->amount, 2)); ?>

                            <span class="amount-currency"><?php echo e($paymentLink->currency); ?></span>
                        </h2>
                    </div>
                    ...
                    <form id="paymentForm" method="POST" action="<?php echo e(route('payment.process', $paymentLink->link_token)); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="amount" value="<?php echo e($paymentLink->amount); ?>" id="amountInput">
                        ...
                        <div class="payment-methods">
                            ...
                            <div class="payment-method-grid" id="paymentMethodGrid">
                                ...
                                <?php if(in_array('card', $paymentMethods)): ?>
                                ...
                                <?php if(in_array('upi', $paymentMethods)): ?>
                                ...
                                <?php if(in_array('netbanking', $paymentMethods)): ?>
                                ...
                                <?php if(in_array('wallet', $paymentMethods)): ?>
                        ...
                        <button type="submit" class="btn btn-pay" id="payButton" disabled>
                            <span id="payButtonText">Pay <?php echo e(number_format($paymentLink->amount, 2)); ?> <?php echo e($paymentLink->currency); ?></span>
                    ...
                    <div class="merchant-info">
                        <small>
                            ...
                            <?php if($paymentLink->merchant): ?>
                                <br>Merchant: <?php echo e($paymentLink->merchant->name); ?>
